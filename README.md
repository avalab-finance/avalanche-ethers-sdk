# Avalanche Ethers.js Wrapper

## How to use provider to query Avalanche chain
...
import { ApiAvalancheProvider } from "../src/provider";

// provider auto detects shard
const provider = new ApiAvalancheProvider("https://api.s0.b.hmny.io");
// to get block with avalanche properties
...
same api as avalanche js sdk

```ts
const address = new AvalancheAddress("one..." || "0x...");
```
